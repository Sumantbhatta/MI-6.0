...
public class MaintenanceReadingsController implements MaintenanceReadingApi{
   ...
   public ResponseEntity<MachinaryMgmtBaseApiResponse> updateMaintenanceReading(Long id,
      ...
      // TODO Auto-generated method stub
      MachineryMaintenanceLog machineryMaintenanceLog= machineryMaintenanceLogService.findById(maintenanceReadingRequestDto.getMaintenanceLogId()).orElseThrow(()-> new RuntimeException("Maintenance Log not found"));
      ...
      existinMaintenanceReading.setMaintenanceLog(machineryMaintenanceLog);
