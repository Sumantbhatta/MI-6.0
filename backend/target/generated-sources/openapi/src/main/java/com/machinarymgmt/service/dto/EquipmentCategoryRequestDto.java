...
public class EquipmentCategoryRequestDto {
  ...
  public EquipmentCategoryRequestDto name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    EquipmentCategoryRequestDto equipmentCategoryRequestDto = (EquipmentCategoryRequestDto) o;
    return Objects.equals(this.name, equipmentCategoryRequestDto.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class EquipmentCategoryRequestDto {\n");
