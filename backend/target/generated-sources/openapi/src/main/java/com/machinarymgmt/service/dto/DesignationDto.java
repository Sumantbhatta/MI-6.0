...
public class DesignationDto {
  ...
  public DesignationDto id(Long id) {
    this.id = id;
    return this;
  }
  ...
  public DesignationDto name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DesignationDto description(String description) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, designationDto.id) &&
        Objects.equals(this.name, designationDto.name) &&
        Objects.equals(this.description, designationDto.description);
  }
  ...
  public String toString() {
    ...
    sb.append("class DesignationDto {\n");
