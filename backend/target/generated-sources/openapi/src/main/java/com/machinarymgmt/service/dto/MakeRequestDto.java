...
public class MakeRequestDto {
  ...
  public MakeRequestDto name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MakeRequestDto makeRequestDto = (MakeRequestDto) o;
    return Objects.equals(this.name, makeRequestDto.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class MakeRequestDto {\n");
