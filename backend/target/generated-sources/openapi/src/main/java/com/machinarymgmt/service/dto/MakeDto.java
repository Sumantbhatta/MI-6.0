...
public class MakeDto {
  ...
  public MakeDto name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, makeDto.id) &&
        Objects.equals(this.name, makeDto.name);
  }
