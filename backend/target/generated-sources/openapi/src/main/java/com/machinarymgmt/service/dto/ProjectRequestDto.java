...
public class ProjectRequestDto {
  ...
  public ProjectRequestDto location(String location) {
  ...
  public ProjectRequestDto startDate(LocalDate startDate) {
  ...
  public ProjectRequestDto endDate(LocalDate endDate) {
  ...
  public ProjectRequestDto status(String status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, projectRequestDto.name) &&
        ...
        Objects.equals(this.location, projectRequestDto.location) &&
        Objects.equals(this.startDate, projectRequestDto.startDate) &&
        Objects.equals(this.endDate, projectRequestDto.endDate) &&
        Objects.equals(this.status, projectRequestDto.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, location, startDate, endDate, status);
  }
