...
public class ProjectSummaryDto {
  ...
  public ProjectSummaryDto id(Long id) {
    this.id = id;
    return this;
  }
  ...
  public ProjectSummaryDto name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, projectSummaryDto.id) &&
        Objects.equals(this.name, projectSummaryDto.name);
  }
