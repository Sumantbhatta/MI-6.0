...
public class ModelResponse extends MachinaryMgmtBaseApiResponse {

  private @Nullable ModelDto data;

  public ModelResponse data(ModelDto data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, modelResponse.data) &&
        super.equals(o);
  }
