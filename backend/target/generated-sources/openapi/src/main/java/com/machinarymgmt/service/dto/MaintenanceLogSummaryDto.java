...
public class MaintenanceLogSummaryDto {
  ...
  public MaintenanceLogSummaryDto id(Long id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MaintenanceLogSummaryDto maintenanceLogSummaryDto = (MaintenanceLogSummaryDto) o;
    return Objects.equals(this.id, maintenanceLogSummaryDto.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class MaintenanceLogSummaryDto {\n");
