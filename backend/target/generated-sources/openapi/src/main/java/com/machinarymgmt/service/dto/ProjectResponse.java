...
public class ProjectResponse extends MachinaryMgmtBaseApiResponse {

  private @Nullable ProjectDto data;

  public ProjectResponse data(ProjectDto data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, projectResponse.data) &&
        super.equals(o);
  }
