...
export type IncidentType = 'MECHANICAL_FAILURE' | 'ELECTRICAL_FAILURE' | 'MAINTENANCE_ISSUE' | 'OPERATOR_ERROR' | 'SAFETY_NEAR_MISS' | 'UNAUTHORIZED_USE' | 'ENVIRONMENTAL_DAMAGE' | 'STRUCTURAL_FAILURE' | 'PERFORMANCE_ISSUE' | 'COMPLIANCE_BREACH';
